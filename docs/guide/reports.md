...
People with Reports **Edit** can open **Publish snapshot** under a brand. They choose a reporting period (year and quarter) and publish. The working profile is marked published; the snapshot still stores its own frozen numbers.
...
This role typically has Reports view only. They do not get Program or the live dashboard. The hamburger shows **Brands** (or they land on reports). They still only see brands their role is allowed to open.
